...
using AA.HRMS.Domain.Providers;
...
namespace AA.HRMS.DI.Windsor.Installers
{
        ...
        : IWindsorInstaller
    {
        ...
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            string[] includeAssembliesForScan = new string[] { "AA.HRMS" };
...
// typeof(SiteMapNodeVisibilityProviderStrategy)
            ...
            container.Register(Component.For(typeof(ISiteMapNodeVisibilityProvider))
                .ImplementedBy(typeof(SiteMapNodeVisibilityProvider))
                .Named("SiteMapNodeVisibilityProvider"));
